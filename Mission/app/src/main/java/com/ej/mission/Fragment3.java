...
public class Fragment3 extends Fragment {
    ...
    private void initUI(ViewGroup rootView) {
        ...
        xAxis3.setValueFormatter(new org.techtown.diary.ValueFormatter() {
    ...
    private void setData2(HashMap<String,Integer> dataHash2) {
        ...
        for (int i = 0; i < keys.length; i++) {
            ...
            org.techtown.diary.AppConstants.println("#" + i + " -> " + outValue);
            if (outValue != null) {
    ...
    private void setData3(ArrayList<Float> dataKeys3, ArrayList<Integer> dataValues3) {
        ...
        for (int i = 0; i < dataKeys3.size(); i++) {
            try {
                ...
                org.techtown.diary.AppConstants.println("#" + i + " -> " + outKey + ", " + outValue);
    ...
    public void loadStatData() {
        ...
        String sql = "select mood " +
                "  , count(mood) " +
                "from " + org.techtown.diary.NoteDatabase.TABLE_NOTE + " " +
        ...
        org.techtown.diary.AppConstants.println("recordCount : " + recordCount);
        ...
        for (int i = 0; i < recordCount; i++) {
            ...
            org.techtown.diary.AppConstants.println("#" + i + " -> " + moodName + ", " + moodCount);
        ...
        for (int i = 0; i < recordCount; i++) {
            ...
            org.techtown.diary.AppConstants.println("#" + i + " -> " + weekDay + ", " + moodCount);
        ...
        for (int i = 0; i < recordCount; i++) {
            ...
            org.techtown.diary.AppConstants.println("#" + i + " -> " + monthDate + ", " + moodCount);
        ...
        for (int i = 0; i < 7; i++) {
            ...
            String monthDate = org.techtown.diary.AppConstants.dateFormat5.format(cal.getTime());
    ...
    public String getToday() {
        ...
        return org.techtown.diary.AppConstants.dateFormat5.format(todayDate);
    }
    ...
    public String getTomorrow() {
        ...
        return org.techtown.diary.AppConstants.dateFormat5.format(cal.getTime());
    }
