...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder>
        implements org.techtown.diary.OnNoteItemClickListener {
    ArrayList<Note> items = new ArrayList<Note>();

    org.techtown.diary.OnNoteItemClickListener listener;
    ...
    public void setOnItemClickListener(org.techtown.diary.OnNoteItemClickListener listener) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, final org.techtown.diary.OnNoteItemClickListener listener, int layoutType) {
            super(itemView);
